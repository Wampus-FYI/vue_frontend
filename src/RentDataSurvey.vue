<template>
    <div class="survey-container">
        ...
        <p>
            Take part in our anonymous survey to help improve housing for other UT students!
            We are making an anonymous database of rent prices for students to reference
            while shopping for housing at UT. Your input will only take one minute of your
            time and will help us improve our services. If you have formerly lived at multiple
            apartment buildings, we would appreciate that you submit this form multiple times
            for us to increase our data collection.
        </p>

        <form @submit.prevent="submitForm">
            <div>
                <label>Which apartment building do you/have you lived in? (ie: Skyloft) </label>
                <input v-model="formData.buildingName" required>
            </div>

            <div>
                <label>What school year did you live there? </label>
                <select v-model="formData.schoolYear" required>
            ...
            <div>
                <label>On a scale of 1 (horrible) to 5 (great), how was your overall experience at the building? </label>
